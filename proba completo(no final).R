  ...
  observeEvent(input$cargar_datos, {
    ...
    resumen_estadistico <- data.frame(
      ...
      Gemelo_1 = c(
        ...
        diff(range(gemelos_completos$HRWAGEL, na.rm = TRUE)),
        var(gemelos_completos$HRWAGEL, na.rm = TRUE),
        sd(gemelos_completos$HRWAGEL, na.rm = TRUE),
        sd(gemelos_completos$HRWAGEL, na.rm = TRUE) / mean(gemelos_completos$HRWAGEL, na.rm = TRUE),
        quantile(gemelos_completos$HRWAGEL, 0.25, na.rm = TRUE),
        quantile(gemelos_completos$HRWAGEL, 0.50, na.rm = TRUE),
      ...
      Gemelo_2 = c(
        ...
        as.numeric(names(sort(table(gemelos_completos$HRWAGEH), decreasing = TRUE)[1])),
        diff(range(gemelos_completos$HRWAGEH, na.rm = TRUE)),
        var(gemelos_completos$HRWAGEH, na.rm = TRUE),
        sd(gemelos_completos$HRWAGEH, na.rm = TRUE),
        sd(gemelos_completos$HRWAGEH, na.rm = TRUE) / mean(gemelos_completos$HRWAGEH, na.rm = TRUE),
        quantile(gemelos_completos$HRWAGEH, 0.25, na.rm = TRUE),
        quantile(gemelos_completos$HRWAGEH, 0.50, na.rm = TRUE),
        quantile(gemelos_completos$HRWAGEH, 0.75, na.rm = TRUE),
        min(gemelos_completos$HRWAGEH, na.rm = TRUE),
